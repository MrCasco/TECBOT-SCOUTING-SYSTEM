<?php
  echo "
  <div><br></div>
  <h1 class = 'title' style = 'text-align:center'>PLAYOFFS</h1>
  ...
  if($toDisplay === "hatch"){
    ...
    $sqlRankingData = "SELECT * FROM ranking_data_playoffs ORDER BY ranking_data_playoffs . avgHatch DESC ";
  ...
  if($toDisplay === "cargo"){
    $sqlRankingData = "SELECT * FROM ranking_data_playoffs ORDER BY ranking_data_playoffs . avgCargo DESC ";
    $resRankingData = mysqli_query($con, $sqlRankingData);
  ...
  if($toDisplay === "scorer"){
    ...
    $sqlRankingData = "SELECT * FROM ranking_data_playoffs ORDER BY ranking_data_playoffs . totalClimbingScore DESC ";
    $resRankingData = mysqli_query($con, $sqlRankingData);
  ...
  if($toDisplay === "avgClimber"){
    ...
    $sqlRankingData = "SELECT * FROM ranking_data_playoffs ORDER BY ranking_data_playoffs . avgClimb DESC ";
    $resRankingData = mysqli_query($con, $sqlRankingData);
  ...
  if($toDisplay === "other"){
    ...
    $sqlRankingData = "SELECT * FROM ranking_data_playoffs ORDER BY ranking_data_playoffs . destroyed DESC ";
    $resRankingData = mysqli_query($con, $sqlRankingData);
  ...
  if($toDisplay === "Auto Cargo"){
    $sqlRankingData = "SELECT * FROM ranking_data_playoffs ORDER BY ranking_data_playoffs . avgAutCargo DESC ";
    $resRankingData = mysqli_query($con, $sqlRankingData);
  ...
  if($toDisplay === "Auto Hatch"){
    $sqlRankingData = "SELECT * FROM ranking_data_playoffs ORDER BY ranking_data_playoffs . avgAutHatch DESC ";
    $resRankingData = mysqli_query($con, $sqlRankingData);
