<?php
  ...
  $sql = "insert into match_data (matchData) values('".$content."')";
  ...
  $sqlMatchData = "SELECT * FROM match_data";
  ...
  function plugNewData($con, $playedMatches, $teamNumber, $disconnections, $np, $def, $totalCargoDrop, $totalDropHatch, $totalCargoPerTeam, $totalHatchPerTeam, $autTotalCargoPerTeam, $autTotalHatchPerTeam, $climbsPerTeam, $climbingScorePerTeam, $parkingPerTeam, $secondLevelPerTeam, $thirdLevelPerTeam, $helpedClimb, $fallsPerTeam, $didNothing, $destroyed, $fellDuringMatch,
    ...
    $sqlRankingData = "SELECT * FROM ranking_data WHERE teamNumber = $teamNumber";
    ...
    if($row = mysqli_fetch_assoc($resRankingData) ){
      $sqlUpdateData = "UPDATE ranking_data SET avgCargo=$avgCargoToPlug WHERE teamNumber=$teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET disconnections=$disconnections[$teamNumber] WHERE teamNumber=$teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET np=$np[$teamNumber] WHERE teamNumber=$teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET def=$def[$teamNumber] WHERE teamNumber=$teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET avgDropHatch=$avgDropHatch WHERE teamNumber=$teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET avgDropCargo=$avgDropCargo WHERE teamNumber=$teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET totalHatches=$totalHatchesToPlug WHERE teamNumber=$teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET totalCargo=$totalCargoToPlug WHERE teamNumber=$teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET playedMatches=$playedMatches[$teamNumber] WHERE teamNumber=$teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET avgHatch = $avgHatchToPlug WHERE teamNumber = $teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET autTotalCargo = $autTotalCargo[$teamNumber] WHERE teamNumber = $teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET autTotalHatches = $autTotalHatches[$teamNumber] WHERE teamNumber = $teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET avgAutCargo = $avgAutCargo WHERE teamNumber = $teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET avgAutHatch = $avgAutHatch WHERE teamNumber = $teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET avgClimb = $avgClimb WHERE teamNumber = $teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET totalClimbs = $climbsPerTeam[$teamNumber] WHERE teamNumber = $teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET totalClimbingScore = $climbingScorePerTeam[$teamNumber] WHERE teamNumber = $teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET totalParking = $parkingPerTeam[$teamNumber] WHERE teamNumber = $teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET totalLevelTwo = $secondLevelPerTeam[$teamNumber] WHERE teamNumber = $teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET totalLevelThree = $thirdLevelPerTeam[$teamNumber] WHERE teamNumber = $teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET fell = $fallsPerTeam[$teamNumber] WHERE teamNumber = $teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET didNothing = $didNothing[$teamNumber] WHERE teamNumber = $teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET destroyed = $destroyed[$teamNumber] WHERE teamNumber = $teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET helpedClimb = $helpedClimb[$teamNumber] WHERE teamNumber = $teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET fellDuringMatch = $fellDuringMatch[$teamNumber] WHERE teamNumber = $teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET autFirstLevel = $autFirstLevelPerTeam[$teamNumber] WHERE teamNumber = $teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET autSecondLevel = $autSecondLevelPerTeam[$teamNumber] WHERE teamNumber = $teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET ceilCargo = $ceilingCargo[$teamNumber] WHERE teamNumber = $teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
      $sqlUpdateData = "UPDATE ranking_data SET ceilHatch = $ceilingHatch[$teamNumber] WHERE teamNumber = $teamNumber";
      $query = mysqli_query($con, $sqlUpdateData);
    }
    else{
      $sqlNewData = "
        insert into ranking_data (teamNumber, playedMatches, avgCargo, avgHatch, np, disconnections, def, avgDropCargo, avgDropHatch, totalHatches, totalCargo, autTotalCargo, autTotalHatches, avgClimb, totalClimbs, totalClimbingScore, totalParking, totalLevelTwo, totalLevelThree, fell, didNothing, destroyed, helpedClimb, fellDuringMatch, avgAutCargo, avgAutHatch, autFirstLevel, autSecondLevel, ceilHatch, ceilCargo)
